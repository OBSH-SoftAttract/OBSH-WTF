...
public class CreditBLServiceImpl implements CreditBLService{
	...
	@Override
	public void recoverCredit (int id,double price, int tag,String orderID){
		...
		CreditPo po=new CreditPo(id,orderID,nowTime.NowTime(),2,CreditChange,afterOperation);
		creditdao.addCredit(po);
	}
	...
	@Override
	public void CutCreditForCancel(int id, double price,String orderID) {
